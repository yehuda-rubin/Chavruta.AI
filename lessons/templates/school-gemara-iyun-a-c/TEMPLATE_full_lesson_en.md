<!--
Template: Full Lesson — Talmudic Analysis (Lamdanut) · Grades 1–3 (Early Elementary) | Chavruta.AI
...
# [Lesson Topic] — Lesson for Grades 1–3

**Target Audience:** Grades 1–3 (ages 6–9 · early elementary) · **Estimated Duration:** 30 min · **Subject:** Talmudic Analysis (Lamdanut)

---

## Introduction & Hook
Experiential opening — a short story, a large visual, a concrete object, or an intriguing question ("What would you do if...?").
...
Teacher narrates or reads the source aloud, translates each term, and paints a vivid picture with words; one core key phrase is repeated together.
...
All together: short skit or gesture, finger following the text, choral completion of key words — lots of repetition and movement.
...
## Deepening — Perspectives of the Commentators
[Introduce **[S3]** and additional commentary; explore the underlying reasons for the disagreement; guide students to compare both views in a structured manner.]
...
Every child individually: drawing the central idea, completing a key sentence, or "tell your partner in one word what we learned."
...
[Restate the core idea in one resonant sentence in student-friendly language, connecting to the central Talmudic principle and its lesson that stays with us.]
...
Calibrated for Grades 1–3; teachers should adjust pacing and depth to fit their students.
