...
- **שיעור מלא לדוגמה** ב-`lessons/kriat-shema-arvit/` על **זמן קריאת שמע של ערבית**:
  - `source_sheet.md` — 11 מקורות אמיתיים מהראג ב-7 שכבות.
  - `lesson_flow.md` — שיעור 60 דק' סביב חידה: מדוע הרמב"ם פסק "עד חצות" בעוד הגמרא פוסקת "הלכה כרבן גמליאל"? (יישוב: הבחנה בין עיקר הדין להרחקה — כס"מ + ברכת אברהם).
