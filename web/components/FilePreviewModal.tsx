...
export function FilePreviewModal({ file, lang, onClose }: { file: FileOut | null; lang: Lang; onClose: () => void }) {
  ...
  return (
    ...
    >
      <div className={`glass rounded-[28px] w-full ${isHtml ? "max-w-4xl" : "max-w-2xl"} max-h-[90vh] flex flex-col overflow-hidden`} dir={lang === "he" ? "rtl" : "ltr"}>
          ...
          <div className="flex items-center gap-2 shrink-0">
            {isPdf ? (
              ...
              <>
                ...
                <button
                  onClick={() => downloadDoc(file.name, file.title || file.name, file.content || "", lang)}
              ...
              <button
                onClick={() => downloadDoc(file.name, file.title || file.name.replace(/\.docx?$/, ""), file.content || "", lang)}
        ...
        {isHtml ? (
          ...
          <div className="p-10 flex flex-col items-center text-center bg-white/40 font-serif leading-relaxed" dir={lang === "he" ? "rtl" : "ltr"}>
