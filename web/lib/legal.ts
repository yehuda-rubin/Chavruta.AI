...
const PRIVACY_HE: Section[] = [
  ...
  { heading: "הזכויות שלך",
    body: "באפשרותך לצפות ולמחוק את השיחות והשיעורים שלך בכל עת מתוך האפליקציה. למחיקת החשבון והנתונים המשויכים אליו — פנה אלינו בכתובת שבסוף. באפשרותך לעדכן פרטים בהגדרות." },
  { heading: "קטינים",
...
const PRIVACY_EN: Section[] = [
  ...
  { heading: "Your Rights",
    body: "You can view and delete your conversations and lessons at any time in the app. To delete your account and its associated data, contact us at the address below. You can update details in settings." },
  { heading: "Minors",
