...
const HE: Section[] = [
  ...
  { heading: "מכסות, תוכניות בתשלום וביטול מנוי",
    body: "השירות עשוי לכלול תוכנית חינמית עם מכסה יומית, ותוכניות בתשלום. אנו רשאים לשנות מכסות, מחירים ותכונות מעת לעת, בהודעה סבירה. ניתן לבטל מנוי בתשלום בכל עת; החיוב יופסק תוך 3 ימי עסקים ממועד הביטול, וההחזר (אם יש) יהיה יחסי לתקופה שלא נוצלה, לפי חוק הגנת הצרכן. ביטול מנוי (הפסקת חיוב) אינו זהה למחיקת חשבון." },
